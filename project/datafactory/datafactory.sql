...
-- 多对多关联表: 定时任务 ↔ 任务
CREATE TABLE IF NOT EXISTS schedule_job_task (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  tenant_id BIGINT NOT NULL DEFAULT 1,
...
-- =============================================
-- 初始化: 管理员用户 (admin / admin123)
-- 密码: admin123 (BCrypt 加密)
-- =============================================
INSERT INTO sys_user (username, password, real_name, email, status, created_by) VALUES
('admin', '$2a$10$l2KLCtdHeXrOYPUsx9kAnutLzc9ElZuiBwQQxTUSWgQ1tydkfxNpW', '系统管理员', '1106935659@qq.com', 1, 'SYSTEM');

-- super_admin 用户补充手机号
UPDATE sys_user SET phone = '17815213110' WHERE username = 'admin';
